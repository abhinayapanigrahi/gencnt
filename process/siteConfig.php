...
class siteConfig {
	...
	function __construct() {
			...
			$this->config = array(
							...
							"cookiePath"=>"/",
							"authentiction_fail_loginURL"=>"http://localhost/genuineconnect/login.php",
							"defaaultIndex"=>"http://localhost/genuineconnect/",
							"logOutPath"=>"../../login.php",
							"indexPage"=>"http://localhost/genuineconnect/index.php"																	
			);
	}
